      ...
      <div className="relative h-full flex flex-col justify-center gap-6 py-4 sm:py-6 px-4 sm:px-8 overflow-hidden">
        <div className="relative flex justify-between w-full h-full items-stretch flex-col">
          <div className="absolute h-full w-full aspect-[578/433] shadow-2xl">
            <Image
              src={"/projects/dapur-refa.png"}
              alt={"Dapur Refa Landing Page"}
              fill
              style={{
                objectFit: "cover",
                objectPosition: "top",
        ...
        <div className="flex flex-col items-start gap-1">
          ...
          <div className="w-full flex gap-2 items-center">
            <h1 className="text-2xl font-medium dark:text-white text-black uppercase opacity-90">
              Dapur Refa Landing Page
            </h1>
            <SendmessageIcon link="./dapur-refa" lottieName="NotesAppIcon" />
          </div>
...
export default DailyactivityApp;
